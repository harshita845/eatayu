...
import { SmokyText } from "../modules/Food/components/ui/SmokyText";
...
export default function LandingPage() {
    ...
    async function fetchSupportInfo() {
      try {
        ...
        if (data && (data.email || data.mobile)) {
          setSupportContact({
            email: data.email || "support@EatAyu.com",
  ...
  return (
    <div ref={containerRef} className="bg-[#FCFBFA] min-h-screen w-full max-w-full text-slate-900 font-sans selection:bg-[#FF6F3C] selection:text-white overflow-x-hidden relative">

      {/* Refined, Subtler Lighting */}
      <div className="absolute top-0 right-0 w-[40vw] h-[40vw] bg-orange-500/10 rounded-full blur-[120px] pointer-events-none z-0" />
      ...
      <header className="absolute top-0 w-full z-50 px-6 py-8 md:px-12 lg:px-20 flex items-center justify-between bg-transparent">
        ...
        <nav className="flex items-center gap-1.5 bg-white/50 backdrop-blur-md border border-slate-200/30 p-1 rounded-full shadow-lg shadow-slate-900/5 relative z-50">
          <a
            href="/"
            className="group flex items-center gap-2 px-3 py-2 md:px-4 md:py-2 rounded-full text-xs font-bold text-slate-700 hover:text-[#FF6F3C] hover:bg-white/80 transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-0.5"
          >
            <Home className="w-4 h-4 md:w-3.5 md:h-3.5 text-slate-500 group-hover:text-[#FF6F3C] transition-colors" />
            <span className="hidden md:inline">Home</span>
          </a>
          <button
            onClick={() => setIsRestaurantOpen(true)}
            className="group flex items-center gap-2 px-3 py-2 md:px-4 md:py-2 rounded-full text-xs font-bold text-slate-700 hover:text-[#FF6F3C] hover:bg-white/80 transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-0.5 cursor-pointer"
          >
            <Store className="w-4 h-4 md:w-3.5 md:h-3.5 text-slate-500 group-hover:text-[#FF6F3C] transition-colors" />
          ...
          <button
            ...
            className="group flex items-center gap-2 px-3 py-2 md:px-4 md:py-2 rounded-full text-xs font-bold text-slate-700 hover:text-[#FF6F3C] hover:bg-white/80 transition-all duration-300 shadow-sm hover:shadow-md hover:-translate-y-0.5 cursor-pointer"
          >
            <Bike className="w-4 h-4 md:w-3.5 md:h-3.5 text-slate-500 group-hover:text-[#FF6F3C] transition-colors" />
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity }} className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full h-full pt-28 lg:pt-20">
          ...
          <div className="col-span-1 flex flex-col justify-center z-20 h-full relative">
            ...
            <div className="overflow-hidden mb-6">
              <motion.div custom={0} initial="hidden" animate="visible" variants={textReveal} className="inline-flex items-center gap-2 text-[#FF6F3C] font-bold tracking-widest uppercase text-xs bg-[#FF6F3C]/10 px-4 py-2 rounded-full">
            ...
            <h1 className="text-[10vw] lg:text-[5.8vw] font-black leading-[0.85] tracking-tighter text-slate-900 relative z-20">
              ...
              <div className="overflow-hidden pb-4">
                <motion.div custom={2} initial="hidden" animate="visible" variants={textReveal} className="flex items-center gap-4 lg:gap-8">
                  <SmokyText text="EatAyu?" appearTrigger="default" isGradient={true} gradientClass="from-[#FF6F3C] to-orange-600" position="bottomLeft" intensity={10} duration={1.2} />
                </motion.div>
              </div>
            </h1>
            ...
            <div className="overflow-hidden mt-6 lg:mt-8">
              <motion.div custom={4} initial="hidden" animate="visible" variants={textReveal}>
                <button
                  ...
                  className="group flex items-center gap-3 bg-slate-900 hover:bg-[#FF6F3C] text-white px-8 py-4 rounded-full font-bold text-sm transition-all duration-500 hover:shadow-xl hover:shadow-[#FF6F3C]/20 cursor-pointer"
                >
      ...
      <section className="relative z-10 py-32 px-6 md:px-16 lg:px-24 max-w-[1800px] mx-auto">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div className="space-y-8">
            <span className="inline-block text-xs font-black tracking-[0.3em] text-[#FF6F3C] uppercase bg-orange-50 border border-orange-100 rounded-full px-3 py-1">
              About EatAyu
            </span>
            <h3 className="text-5xl lg:text-7xl font-black leading-[1.1] tracking-tight text-slate-900">
              Empowering partners, <br />
              <SmokyText
                text="restoring trust."
                appearTrigger="scroll"
                color="#64748B"
                className="italic font-light text-slate-500 text-5xl lg:text-7xl"
                position="bottomLeft"
                intensity={8}
                duration={1.4}
              />
            ...
            <div className="pt-2">
              <button
                onClick={() => setIsAboutOpen(true)}
                className="group inline-flex items-center gap-2.5 text-slate-900 hover:text-[#FF6F3C] font-bold text-sm tracking-wide uppercase transition-colors"
              >
          ...
          <div className="relative h-[400px] lg:h-[600px] rounded-[2.5rem] overflow-hidden group shadow-2xl border-4 border-white">
            <div className="absolute inset-0 bg-[#FF6F3C] mix-blend-overlay opacity-10 z-10 group-hover:opacity-0 transition-opacity duration-700" />
            <img
        ...
        <div className="max-w-[1800px] mx-auto px-6 md:px-16 lg:px-24 flex flex-col lg:flex-row items-center gap-20">
            ...
            <motion.div style={{ scale: scalePhone, rotateZ: rotatePhone }} className="relative w-[290px] sm:w-[320px] h-[580px] sm:h-[640px] mx-auto perspective-1000">
              ...
              <div className="absolute inset-0 rounded-[3rem] bg-slate-900 p-2 shadow-[0_40px_80px_rgba(15,23,42,0.12)] border border-slate-800 transform-style-3d shadow-2xl">
                ...
                <div className="w-full h-full bg-white rounded-[2.5rem] overflow-hidden relative border border-slate-100">
                  ...
                  <div className="absolute bottom-0 w-full h-[50%] bg-gradient-to-t from-white via-white to-transparent p-6 flex flex-col justify-end">
                    ...
                    <p className="text-slate-500 text-xs font-semibold mb-4">Japanese • 4.9 <Star className="inline w-3 h-3 text-[#FF6F3C] fill-[#FF6F3C] mb-0.5" /></p>
                    <button className="w-full bg-slate-900 text-white py-3.5 rounded-2xl font-bold hover:bg-[#FF6F3C] transition-colors duration-300 text-sm shadow-md">
                      Track Delivery
                    </button>
                  </div>
                </div>
              ...
              >
                <div className="w-10 h-10 rounded-full bg-orange-50 flex items-center justify-center shrink-0">
                  <Clock className="w-5 h-5 text-[#FF6F3C]" />
                </div>
                <div>
          ...
          <div className="flex-1 space-y-8 order-1 lg:order-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <a
                href="https://apps.apple.com/in/app/EatAyu/id6766444150"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-3 bg-slate-900 text-white hover:bg-[#FF6F3C] px-8 py-4 rounded-2xl font-bold transition-all duration-300 text-sm shadow-md shadow-slate-900/10 cursor-pointer"
              >
      ...
      <section className="relative z-10 py-36 bg-[#030303] text-slate-100 overflow-hidden">
        ...
        <div
          ...
          style={{
            background: `radial-gradient(circle at 50% 50%, ${activeCraving === 0 ? '#FF6F3C' : activeCraving === 1 ? '#EB590E' : '#EAB308'
              } 0%, transparent 60%)`
          }}
        />
        ...
        <div className="max-w-[1800px] mx-auto px-6 md:px-16 lg:px-24 relative z-10">
          ...
          <div className="text-center mb-24">
            <span className="inline-flex items-center gap-2 text-[10px] font-black tracking-[0.35em] text-[#FF6F3C] uppercase bg-[#FF6F3C]/10 border border-[#FF6F3C]/30 rounded-full px-4 py-2 mb-6">
              <span className="h-1.5 w-1.5 rounded-full bg-[#FF6F3C] animate-ping" />
              Midnight Gastronomy
            </span>
            <h3 className="text-5xl md:text-7xl lg:text-8xl font-black tracking-tight text-white mb-6">
              Late Night <SmokyText
                text="Cravings."
                appearTrigger="scroll"
                isGradient={true}
                gradientClass="from-slate-200 via-slate-400 to-[#FF6F3C]"
                className="italic font-light text-5xl md:text-7xl lg:text-8xl"
                position="bottomLeft"
                intensity={12}
                duration={1.6}
              />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
              ...
              {[
                ...
                return (
                  <div
                    ...
                    className={`group relative rounded-[2rem] p-8 cursor-pointer border transition-all duration-500 ease-out select-none ${isActive
                  ...
                  >
                    ...
                    <div
                      className={`absolute left-0 top-8 bottom-8 w-1 rounded-r-full transition-all duration-500 ${isActive ? "scale-y-100 opacity-100" : "scale-y-0 opacity-0 group-hover:scale-y-50 group-hover:opacity-50"
                        }`}
                    ...
                    <div className="flex gap-6 items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <div
                          className={`transition-all duration-500 ease-in-out overflow-hidden ${isActive ? "max-h-[300px] mt-4 opacity-100" : "max-h-0 opacity-0"
                            }`}
                        >
            ...
            <div className="lg:col-span-7 flex justify-center items-center order-1 lg:order-2 h-[500px] md:h-[600px] relative">
              ...
              <div
                ...
                style={{
                  background: activeCraving === 0 ? '#FF6F3C' : activeCraving === 1 ? '#EB590E' : '#EAB308'
                }}
              />
      ...
      <section className="relative z-10 py-20 md:py-24 px-6 md:px-12 lg:px-20 max-w-[1800px] mx-auto bg-[#FCFBFA]">
        ...
        <div className="mb-12 md:mb-16 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            <span className="inline-block text-xs font-black tracking-[0.3em] text-[#FF6F3C] uppercase bg-[#FF6F3C]/10 border border-[#FF6F3C]/20 rounded-full px-4 py-1.5 mb-6">
              The Experience
            </span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 h-auto md:h-[600px]">
          ...
          <div className="md:col-span-4 flex flex-col gap-6 h-full">
            ...
            >
              <div className="w-12 h-12 bg-orange-50 rounded-xl flex items-center justify-center border border-orange-100 group-hover:bg-[#FF6F3C] transition-colors duration-500">
                <Map className="w-5 h-5 text-[#FF6F3C] group-hover:text-white transition-colors duration-500" />
              </div>
              <div>
            ...
            >
              ...
              {/* Sub-card B */}
              <div className="col-span-1 rounded-[2rem] bg-slate-900 p-5 md:p-6 flex flex-col justify-between border border-slate-800 group hover:bg-[#FF6F3C] transition-colors duration-500 shadow-lg">
      ...
      <section className="relative z-10 py-24 px-6 md:px-16 lg:px-24 max-w-[1800px] mx-auto overflow-hidden">
        ...
        <div className="absolute top-[20%] right-[-10%] w-[30vw] h-[30vw] bg-orange-500/5 rounded-full blur-[120px] pointer-events-none z-0" />
        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 items-center relative z-10">
          ...
          <div className="lg:col-span-5 space-y-8">
            <div className="space-y-4">
              <span className="inline-flex items-center gap-2 text-xs font-black tracking-[0.25em] text-[#FF6F3C] uppercase bg-[#FF6F3C]/10 border border-[#FF6F3C]/20 rounded-full px-4 py-2">
            ...
            {/* Features list */}
            <div className="space-y-4">
              <div className="group bg-white/70 backdrop-blur-md border border-slate-200/50 p-6 rounded-2xl hover:shadow-xl hover:shadow-orange-500/5 transition-all duration-300 flex items-start gap-4">
                <div className="w-12 h-12 rounded-xl bg-[#FF6F3C]/10 flex items-center justify-center text-[#FF6F3C] shrink-0">
          ...
          <div className="lg:col-span-7 flex justify-center w-full">
            ...
            >
              ...
              <motion.div
                className="absolute left-0 right-0 h-[100px] bg-gradient-to-b from-[#FF6F3C]/0 via-[#FF6F3C]/5 to-[#FF6F3C]/0 pointer-events-none z-0 border-y border-[#FF6F3C]/5"
              ...
              <div className="relative z-10 flex items-center justify-between border-b border-slate-800/80 pb-4 shrink-0">
                <div className="flex items-center gap-3">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#FF6F3C] animate-pulse" />
              ...
              <div className="relative z-10 flex-1 flex items-center justify-center py-4 overflow-hidden select-none pointer-events-none">
                ...
                <div
                  className="hidden lg:block absolute top-[61.5%] left-[46.8%] w-[10.2%] h-[1.5px] bg-gradient-to-r from-[#FF6F3C] to-[#FF6F3C]/40 z-20 pointer-events-none"
                ...
                <div className="absolute top-[61.5%] left-[46.8%] -translate-x-1/2 -translate-y-1/2 z-20">
                  ...
                  <span className="relative block rounded-full h-2.5 w-2.5 bg-white shadow-[0_0_8px_#fff,0_0_12px_#FF6F3C]" />
                </div>
      ...
      <section className="relative z-10 py-32 px-6 md:px-16 lg:px-24 max-w-[1800px] mx-auto">
        <div className="flex flex-col lg:flex-row items-center gap-20">
            ...
            <div className="grid grid-cols-1 gap-4 pt-4">
              {[
                ...
                <motion.div
                  ...
                  className="flex gap-4 p-4 rounded-2xl bg-slate-50/50 border border-slate-200/60 hover:bg-white hover:border-[#FF6F3C]/20 hover:shadow-lg transition-all duration-300 group cursor-pointer"
                >
                  <div className="w-10 h-10 rounded-xl bg-orange-50 border border-orange-100 flex items-center justify-center text-[#FF6F3C] group-hover:bg-[#FF6F3C] group-hover:text-white transition-all duration-300 shrink-0">
          ...
          <div className="flex-1 w-full h-[380px] sm:h-[500px] relative rounded-[2.5rem] border border-slate-200/80 bg-slate-50/50 backdrop-blur-sm overflow-hidden flex items-center justify-center shadow-xl">
            ...
            <div className="absolute inset-0 pointer-events-none bg-[radial-gradient(circle_at_50%_50%,rgba(255,111,60,0.025)_0%,transparent_60%)] z-0" />
            <div className="absolute top-[20%] left-[20%] w-[350px] h-[350px] bg-orange-100/30 rounded-full blur-[80px] opacity-40 pointer-events-none" />
            ...
            <div className="hidden sm:flex absolute sm:bottom-6 sm:left-6 bg-white/90 backdrop-blur-md border border-slate-200/50 sm:p-4 rounded-2xl flex-col gap-1 shadow-md z-20 sm:text-xs sm:w-[220px]">
              <div className="flex items-center gap-1.5 font-bold text-slate-800">
                <Zap className="w-3.5 h-3.5 text-[#FF6F3C]" /> <span>Rider Telemetry</span>
              </div>
            ...
            <div className="hidden sm:block absolute top-[18%] left-[10%] bg-orange-50/95 backdrop-blur-sm border border-orange-100 px-3 py-1 rounded-xl text-[9px] font-black tracking-widest text-[#FF6F3C] shadow-sm z-20 animate-pulse">
              KITCHEN PICKUP
            </div>
            ...
            <svg viewBox="0 0 400 300" className="w-full h-full max-w-[400px] relative z-10 p-6">
              ...
              <motion.path
                ...
                style={{ filter: "drop-shadow(0px 0px 8px rgba(255,111,60,0.5))" }}
              />
              <circle cx="50" cy="250" r="8" fill="#FF6F3C" className="shadow-[0_0_10px_#FF6F3C]" />
          ...
          <div className="grid lg:grid-cols-5 gap-16 mb-24 relative z-10">
            <div className="lg:col-span-2">
              <h2 className="text-5xl font-black tracking-tighter text-slate-950 mb-6">
                {APP_CONFIG?.NAME || "BRAND"}<span className="text-[#FF6F3C]">.</span>
              </h2>
            ...
            <div className="flex flex-col gap-5 text-sm font-medium">
              ...
              <a href={`mailto:${supportContact.email}`} className="hover:text-[#FF6F3C] transition-colors">{supportContact.email}</a>
              <a href={`tel:${supportContact.mobile}`} className="hover:text-[#FF6F3C] transition-colors">{supportContact.mobile}</a>
      ...
      <AnimatePresence>
        {isAboutOpen && (
          <motion.div
            ...
            data-lenis-prevent
            className="fixed inset-0 z-[100] w-screen h-screen bg-[#FCFBFA] overflow-y-auto flex flex-col selection:bg-[#FF6F3C] selection:text-white"
          >
            {/* Ambient Background Lights */}
            <div className="absolute top-0 right-0 w-[50vw] h-[50vw] bg-orange-500/10 rounded-full blur-[140px] pointer-events-none z-0" />
            ...
            <header className="sticky top-0 w-full z-50 px-6 py-6 md:px-12 lg:px-20 flex items-center justify-between bg-[#FCFBFA]/80 backdrop-blur-md border-b border-slate-200/40 shrink-0">
              <div className="text-2xl font-black text-slate-900 tracking-tighter">
                {APP_CONFIG?.NAME || "EatAyu"}
                <span className="text-[#FF6F3C]">.</span>
              </div>
              <button
                onClick={() => setIsAboutOpen(false)}
                className="group flex items-center gap-2 bg-slate-900 text-white px-5 py-2.5 rounded-full text-xs font-bold hover:bg-[#FF6F3C] transition-all duration-300 shadow-md hover:shadow-lg shadow-slate-900/10 cursor-pointer"
              >
            ...
            <main className="flex-1 relative z-10 w-full max-w-[1400px] mx-auto px-6 py-12 md:py-20 lg:px-20 flex flex-col gap-12 md:gap-20">
              ...
              <div className="max-w-3xl space-y-6">
                <span className="inline-flex items-center gap-2 text-[#FF6F3C] font-bold tracking-widest uppercase text-xs bg-[#FF6F3C]/10 px-4 py-2 rounded-full">
                ...
                <p className="text-xl text-slate-600 font-light leading-relaxed">
                  EatAyu is built with a mission to create a sustainable, transparent, and balanced environment for both food merchants and consumers across India.
                </p>
              </div>
              ...
              <div className="bg-slate-900 text-white rounded-[2.5rem] p-8 md:p-14 relative overflow-hidden shadow-2xl shrink-0">
                <div className="absolute top-[-50%] right-[-10%] w-[350px] h-[350px] bg-[#FF6F3C]/20 rounded-full blur-[90px] pointer-events-none" />
                <div className="relative z-10 space-y-6">
                  <p className="text-2xl md:text-3xl lg:text-4xl font-light leading-relaxed italic text-slate-100 max-w-4xl">
                    "EatAyu isn’t just a food delivery app—it’s a movement towards fair business, trust, and transparency."
                  </p>
                  <div className="w-16 h-1 bg-[#FF6F3C] rounded-full" />
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12 shrink-0">
                ...
                <div className="group bg-white border border-slate-200/60 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-orange-500/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                  ...
                  <div className="mt-8 pt-6 border-t border-slate-100 flex items-center gap-3">
                    <Zap className="w-4 h-4 text-[#FF6F3C]" />
                ...
                <div className="group bg-white border border-slate-200/60 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-orange-500/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-600 font-light leading-relaxed">
                      By offering transparent pricing, EatAyu ensures customers pay genuine prices without hidden markups. We are building long-term relationships of trust with both restaurants and consumers.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-100 flex items-center gap-3">
                ...
                <div className="group bg-white border border-slate-200/60 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-orange-500/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-600 font-light leading-relaxed">
                      EatAyu was founded by two passionate 23-year-old entrepreneurs driven by a vision to revolutionize the food delivery industry and create a more balanced, fair, and growth-oriented platform for all stakeholders.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-100 flex items-center gap-3">
              ...
              <div className="text-center py-12 md:py-20 border-t border-slate-200/60 flex flex-col items-center gap-6 shrink-0">
                ...
                <p className="text-slate-500 max-w-lg font-light">
                  Support your local neighborhood restaurants. Join EatAyu today as a customer or partner and help us create a fair ecosystem.
                </p>
                <div className="flex gap-4 mt-2">
                  <button
                    onClick={() => setIsAboutOpen(false)}
                    className="bg-slate-900 text-white hover:bg-[#FF6F3C] px-8 py-4 rounded-full font-bold text-sm transition-all duration-300 shadow-md shadow-slate-900/10 cursor-pointer"
                  >
                    Return to Homepage
                  </button>
                </div>
            ...
            <footer className="bg-slate-50 border-t border-slate-200/50 py-8 text-center text-xs text-slate-400 font-medium shrink-0">
              <p>© 2026 {APP_CONFIG?.NAME || "EatAyu"} Technologies Inc. All rights reserved.</p>
            </footer>
          </motion.div>
        )}
        ...
        {isRestaurantOpen && (
          <motion.div
            ...
            transition={{ type: "spring", damping: 28, stiffness: 220 }}
            data-lenis-prevent
            className="fixed inset-0 z-[100] w-screen h-screen bg-[#FAF7F2] overflow-y-auto flex flex-col selection:bg-[#FF6F3C] selection:text-white"
          >
            {/* Ambient Background Lights - Signature Pink and Warm Amber */}
            <div className="absolute top-0 right-0 w-[50vw] h-[50vw] bg-[#FF6F3C]/5 rounded-full blur-[140px] pointer-events-none z-0" />
            <div className="absolute bottom-0 left-0 w-[40vw] h-[40vw] bg-orange-400/5 rounded-full blur-[120px] pointer-events-none z-0" />
            ...
            <main className="flex-1 relative z-10 w-full max-w-[1400px] mx-auto px-6 py-12 md:py-20 lg:px-20 flex flex-col gap-12 md:gap-20">
              ...
              <div className="max-w-4xl space-y-6 text-center mx-auto mb-4">
                <span className="inline-flex items-center gap-2 text-[#FF6F3C] font-black tracking-widest uppercase text-xs bg-[#FF6F3C]/10 border border-[#FF6F3C]/20 px-4 py-2 rounded-full">
              ...
              <div className="bg-slate-900 text-white rounded-[2.5rem] p-8 md:p-14 relative overflow-hidden shadow-2xl shrink-0 flex flex-col lg:flex-row items-center gap-12 border border-slate-800">
                <div className="absolute top-[-50%] right-[-10%] w-[350px] h-[350px] bg-[#FF6F3C]/10 rounded-full blur-[90px] pointer-events-none" />
                ...
                <div className="flex-1 space-y-6 relative z-10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-2">
                    <a
                      href="https://apps.apple.com/in/app/EatAyu-partner/id6766466794"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-3 bg-white text-slate-950 hover:bg-[#FF6F3C] hover:text-white px-8 py-4 rounded-2xl font-bold transition-all duration-300 text-sm shadow-md cursor-pointer text-center"
                    >
                  ...
                  <div className="w-full max-w-[380px] h-[250px] bg-slate-900 border-4 border-slate-700 rounded-2xl shadow-2xl p-4 flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="flex items-center justify-between border-b border-slate-800 pb-2 shrink-0 mt-1">
                      <div className="flex items-center gap-2">
                        <Store className="w-4 h-4 text-[#FF6F3C]" />
                        <span className="text-[10px] text-white font-bold tracking-wider uppercase">Live POS Terminal</span>
                      </div>
                      <span className="text-[8px] bg-orange-500/10 text-[#FF6F3C] px-2 py-0.5 rounded-full font-bold uppercase">Online</span>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3 py-2 flex-1 items-center">
                      ...
                      <div className="bg-slate-950 border border-slate-800 rounded-lg p-2.5 text-center relative opacity-80">
                        ...
                        <div className="text-[7px] text-[#FF6F3C] mt-0.5 font-bold">30% Aggregator Cut</div>
                      </div>
                    </div>

                    {/* POS Footer bar */}
                    <div className="bg-[#FF6F3C] text-white text-[9px] font-black text-center py-2 rounded-lg uppercase tracking-widest shrink-0">
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12 shrink-0">
                ...
                {/* Benefit 1 */}
                <div className="group bg-white/80 border border-slate-200/40 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-[#FF6F3C]/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between shadow-sm">
                  <div>
                ...
                <div className="group bg-white/80 border border-slate-200/40 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-[#FF6F3C]/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between shadow-sm">
                  <div>
                    ...
                    <p className="text-slate-600 font-light leading-relaxed">
                      Say goodbye to frustrating weekly payout cycles that lock up your operating capital. EatAyu processes bank settlements daily, keeping your cash flow running smoothly.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-200/50 flex items-center gap-3">
                    <ShieldCheck className="w-4 h-4 text-[#FF6F3C]" />
                ...
                <div className="group bg-white/80 border border-slate-200/40 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-[#FF6F3C]/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between shadow-sm">
                  <div>
                    ...
                    <p className="text-slate-600 font-light leading-relaxed">
                      Easily adjust your digital menu in real-time. EatAyu items on or off, edit prices directly to protect your margins, customize add-ons, and roll out special promotional offers instantly.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-200/50 flex items-center gap-3">
                    <Map className="w-4 h-4 text-[#FF6F3C]" />
                ...
                <div className="group bg-white/80 border border-slate-200/40 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-[#FF6F3C]/5 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between shadow-sm">
                  ...
                  <div className="mt-8 pt-6 border-t border-slate-200/50 flex items-center gap-3">
                    <Users className="w-4 h-4 text-[#FF6F3C]" />
        ...
        {isDeliveryOpen && (
          <motion.div
            ...
            transition={{ type: "spring", damping: 28, stiffness: 220 }}
            data-lenis-prevent
            className="fixed inset-0 z-[100] w-screen h-screen bg-[#07080B] text-slate-100 overflow-y-auto flex flex-col selection:bg-[#FF6F3C] selection:text-white"
          >
            ...
            <header className="sticky top-0 w-full z-50 px-6 py-6 md:px-12 lg:px-20 flex items-center justify-between bg-[#07080B]/90 backdrop-blur-md border-b border-slate-800/80 shrink-0">
              ...
              <button
                ...
                className="group flex items-center gap-2 bg-slate-900 border border-slate-800 text-white px-5 py-2.5 rounded-full text-xs font-bold hover:bg-[#FF6F3C] hover:border-[#FF6F3C] transition-all duration-300 shadow-md hover:shadow-lg cursor-pointer"
              >
                <ArrowLeft className="w-3.5 h-3.5 group-hover:-translate-x-0.5 transition-transform" />
                Back to Home
              </button>
            ...
            <main className="flex-1 relative z-10 w-full max-w-[1400px] mx-auto px-6 py-12 md:py-20 lg:px-20 flex flex-col gap-12 md:gap-20">
              ...
              <div className="max-w-4xl space-y-6 text-center mx-auto mb-4">
                <span className="inline-flex items-center gap-2 text-[#FF6F3C] font-black tracking-widest uppercase text-xs bg-[#FF6F3C]/15 border border-[#FF6F3C]/30 px-4 py-2 rounded-full animate-pulse">
                  <Bike className="w-4 h-4 text-[#FF6F3C]" /> Active Captain HUD Dashboard
                </span>
                <h1 className="text-5xl md:text-7xl font-black leading-[1.05] tracking-tight text-white">
                  Drive on Your Terms. <br />
                  <span className="text-transparent bg-clip-text bg-gradient-to-br from-[#FF6F3C] to-indigo-400 font-extrabold italic font-light">Earn More & Cash Out Faster.</span>
                </h1>
                <p className="text-xl text-slate-400 font-light leading-relaxed max-w-3xl mx-auto">
                  Join the elite squad of EatAyu Captains. Secure the most competitive distance-based payout structure, absolute route clarity, weekly settlements, and <strong>keep 100% of your customer tips</strong>.
                </p>
              </div>
              ...
              <div className="bg-slate-950 text-white rounded-[2.5rem] p-8 md:p-14 relative overflow-hidden shadow-2xl shrink-0 flex flex-col lg:flex-row items-center gap-12 border border-slate-900">
                ...
                <div className="flex-1 space-y-6 relative z-10">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-2">
                    <a
                      href="https://apps.apple.com/in/app/EatAyu-captain/id6766778164"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center justify-center gap-3 bg-white text-slate-950 hover:bg-[#FF6F3C] hover:text-white px-8 py-4 rounded-2xl font-bold transition-all duration-300 text-sm shadow-md cursor-pointer text-center"
                    >
                ...
                <div className="w-full lg:w-[350px] shrink-0 flex justify-center relative z-10">
                  <div className="w-[260px] h-[340px] bg-slate-900 border-4 border-slate-800 rounded-[2.5rem] shadow-2xl p-4 flex flex-col justify-between relative overflow-hidden">
                    ...
                    <div className="flex items-center justify-between mt-2 shrink-0">
                      ...
                      <span className="text-[8px] text-[#FF6F3C] font-black tracking-widest bg-[#FF6F3C]/15 px-2 py-0.5 rounded border border-[#FF6F3C]/30">GPS Active</span>
                    </div>
                    ...
                    <div className="bg-slate-950/80 border border-slate-850 rounded-xl p-3 my-2 flex-1 flex flex-col justify-between relative overflow-hidden">
                      ...
                      <div className="flex-1 flex items-center justify-center relative my-2">
                        <svg className="w-full h-16" viewBox="0 0 100 40">
                          ...
                          {/* Point B */}
                          <circle cx="90" cy="20" r="3.5" fill="#FF6F3C" className="animate-pulse" />
                        </svg>
                      </div>
                    ...
                    <div className="bg-gradient-to-r from-[#FF6F3C] to-indigo-600 text-white text-[10px] font-black text-center py-2.5 rounded-xl uppercase tracking-wider shrink-0 cursor-pointer shadow-lg shadow-orange-500/20">
                      Deliver Order
                    </div>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 lg:gap-12 shrink-0">
                ...
                {/* Benefit 1 */}
                <div className="group bg-slate-900/40 border border-slate-800/80 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-orange-500/5 hover:border-[#FF6F3C]/30 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    <div className="w-14 h-14 rounded-2xl bg-[#FF6F3C]/10 border border-[#FF6F3C]/20 flex items-center justify-center text-[#FF6F3C] mb-6 group-hover:scale-110 transition-transform">
                      <Heart className="w-7 h-7" />
                    </div>
                    <h3 className="text-2xl font-black text-white mb-3 tracking-tight">Keep 100% Customer Tips</h3>
                    <p className="text-slate-400 font-light leading-relaxed">
                      Every single rupee that a grateful customer tips you belongs entirely to you. EatAyu takes zero cuts from your extra rewards. Honest payouts, guaranteed.
                    </p>
                  </div>
                ...
                <div className="group bg-slate-900/40 border border-slate-800/80 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-orange-500/5 hover:border-[#FF6F3C]/30 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-400 font-light leading-relaxed">
                      Work when you want, where you want. No rigid shift systems, no penalty zones. Set your status to active whenever you are ready to earn, and EatAyu off seamlessly.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-800/60 flex items-center gap-3">
                    <ShieldCheck className="w-4 h-4 text-[#FF6F3C]" />
                ...
                <div className="group bg-slate-900/40 border border-slate-800/80 rounded-[2rem] p-8 lg:p-10 hover:shadow-2xl hover:shadow-orange-500/5 hover:border-[#FF6F3C]/30 hover:-translate-y-1 transition-all duration-500 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-slate-400 font-light leading-relaxed">
                      Never wait weeks to enjoy your hard-earned rewards. EatAyu settles your total earnings straight into your active digital wallet every single week, cleanly and securely.
                    </p>
                  </div>
                  <div className="mt-8 pt-6 border-t border-slate-800/60 flex items-center gap-3">
                    <Map className="w-4 h-4 text-[#FF6F3C]" />
              ...
              <div className="text-center py-12 md:py-20 border-t border-slate-800/80 flex flex-col items-center gap-6 shrink-0">
                <h3 className="text-3xl md:text-4xl font-black text-white">Start Earning with EatAyu</h3>
                ...
                <div className="flex gap-4 mt-2">
                  <button
                    onClick={() => setIsDeliveryOpen(false)}
                    className="bg-slate-900 hover:bg-[#FF6F3C] text-white border border-slate-800 hover:border-[#FF6F3C] px-8 py-4 rounded-full font-bold text-sm transition-all duration-300 shadow-md cursor-pointer"
                  >
                    Return to Homepage
                  </button>
                </div>
