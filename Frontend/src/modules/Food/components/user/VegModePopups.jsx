...
const VegModePopups = ({
  ...
  return (
    <>
      ...
      {/* Pure Veg Mode EatAyu Off Confirmation */}
      {createPortal(
        <AnimatePresence>
          {showEatAyuOffPopup && (
            <div className="fixed inset-0 z-[1000] flex items-center justify-center p-4">
              ...
              >
                ...
                <div className="relative text-center">
                  ...
                  <h3 className="text-2xl font-black text-gray-900 dark:text-white mb-3">EatAyuing Off?</h3>
                  <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed mb-8">
                    This will re-enable non-vegetarian options in your feed. Are you sure you want to continue?
                  </p>
                  <div className="flex flex-col gap-3">
                    <button
                      onClick={onConfirmEatAyuOff}
