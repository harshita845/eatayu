...
export const useRestaurantNotifications = () => {
  ...
  useEffect(() => {
    ...
    if (shouldBlockConnection) {
      ...
      // Common patterns:
      // - If frontend is on foods.EatAyu.com, backend might be api.foods.EatAyu.com or foods.EatAyu.com
      if (frontendHost.includes('foods.EatAyu.com')) {
        suggestedBackendUrl = `${frontendProtocol}//api.foods.EatAyu.com/api`;
      } else if (frontendHost.includes('EatAyu.com')) {
