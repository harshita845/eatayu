          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select
                ...
                className={`w-full px-4 py-2.5 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm ${formErrors.deliveryman ? "border-red-500" : "border-slate-300"
                  }`}
              >
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ex: 100"
                className={`w-full px-4 py-2.5 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm ${formErrors.amount ? "border-red-500" : "border-slate-300"
                  }`}
              />
            ...
            <div>
              ...
              <input
                ...
                placeholder="Ex: Cash"
                className={`w-full px-4 py-2.5 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm ${formErrors.method ? "border-red-500" : "border-slate-300"
                  }`}
              />
