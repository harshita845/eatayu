...
function ToggleEatAyu({ enabled, onToggle }) {
  return (
    <button
      type="button"
      onClick={onToggle}
        ...
        <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-2 mb-3">
          <div className="flex gap-2">
            <button
              ...
              className={`px-4 py-2 rounded-lg text-xs font-medium transition-colors ${activeTab === "ai-configuration"
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-xs font-medium transition-colors ${activeTab === "ai-settings"
                  ? "bg-blue-600 text-white"
                  : "text-slate-600 hover:bg-slate-100"
                }`}
            >
