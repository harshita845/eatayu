          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <select
                ...
                className={`w-full px-4 py-2.5 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm ${formErrors.deliveryPartnerId ? "border-red-500" : "border-slate-300"
                  }`}
                disabled={submitting}
              >
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-2.5 border rounded-lg bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm ${formErrors.amount ? "border-red-500" : "border-slate-300"
                  }`}
                disabled={submitting}
              />
