...
export default function JoiningRequest() {
  ...
  useEffect(() => {
    ...
    // On subsequent tab changes, refetch only when EatAyuing away from "pending"
                    ...
                    <div className="flex items-start gap-6 pb-6 border-b border-slate-200">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 flex-wrap">
                          ...
                          <span className={`px-3 py-1 rounded-full text-xs font-medium ${approvalStatus === "approved" ? "bg-green-100 text-green-700" : approvalStatus === "rejected" ? "bg-red-100 text-red-700" : "bg-amber-100 text-amber-700"
                            }`}>
