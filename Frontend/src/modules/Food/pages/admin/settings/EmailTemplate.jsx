        ...
        <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4 mb-6">
          <div className="flex flex-wrap gap-2 mb-4">
            {templates.map((template) => (
              <button
                ...
                className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${activeTemplate === template.id
          ...
          <div className="flex items-center justify-between pt-4 border-t border-slate-200">
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${sendMailEnabled ? "bg-blue-600" : "bg-slate-300"
                }`}
            >
              <span
                className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${sendMailEnabled ? "translate-x-6" : "translate-x-1"
                  }`}
              />
            </button>
          </div>
            ...
            <div className="flex gap-2 mb-6 border-b border-slate-200 pb-4">
              {languages.map((lang) => (
                <button
                  ...
                  className={`px-3 py-1.5 text-sm font-medium rounded transition-colors ${activeLanguage === lang.id
                      ? "bg-blue-600 text-white"
