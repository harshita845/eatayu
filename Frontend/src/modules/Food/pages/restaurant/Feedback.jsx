        ...
        <div className="flex gap-2 mt-4 md:mt-5">
          {tabs.map((tab) => (
            <button
              ...
              className={`px-6 py-2 rounded-full text-sm font-bold transition-all md:px-8 md:py-2.5 ${activeTab === tab.id ? "" : "bg-white text-gray-600 border border-gray-200 md:bg-slate-100 md:border-slate-200"
                }`}
              style={
                activeTab === tab.id
                  ? {
                ...
                {filteredComplaints.map((complaint) => (
                  ...
                  >
                    <div className="flex justify-between items-center">
                      <span
                        className={`text-[9px] font-black px-2 py-0.5 rounded-full uppercase tracking-tighter ${complaint.status === "open" ? "bg-orange-100 text-orange-600" : "bg-green-100 text-green-600"
                          }`}
                      >
