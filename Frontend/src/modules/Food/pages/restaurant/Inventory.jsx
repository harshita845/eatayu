...
export default function Inventory() {
  ...
  const handleSaveAddon = async () => {
    ...
    try {
      let imageUrl = ""
      if (addonImageFile) {
        const uploadRes = await uploadAPI.uploadMedia(addonImageFile, { folder: "EatAyu/restaurant/addons" })
        ...
        <div className="md:px-6 md:py-4 flex md:items-center md:justify-between md:gap-6">
          <div ref={tabBarRef} className="grid grid-cols-2 gap-3 md:inline-flex md:bg-slate-100 md:rounded-xl md:p-1 md:grid-cols-none md:gap-1 w-full md:w-auto">
            <motion.button
              ...
              className={`relative overflow-hidden rounded-[24px] md:rounded-xl border md:border-none px-5 py-4 md:py-2 text-sm font-semibold whitespace-nowrap ${activeTab === "all-items"
            ...
            >
              ...
              <span className="relative z-10 flex items-center justify-center gap-2">
                ...
                <span className={`rounded-full px-2 py-0.5 text-xs font-semibold ${activeTab === "all-items" ? "" : "bg-slate-100 text-slate-600"
                  }`} style={activeTab === "all-items" ? {
            ...
            <motion.button
              ...
              className={`relative overflow-hidden rounded-[24px] md:rounded-xl border md:border-none px-5 py-4 md:py-2 text-sm font-semibold whitespace-nowrap ${activeTab === "add-ons"
                  ? "text-white md:shadow-none"
                  : "border-white/80 bg-white/80 text-slate-700 shadow-[0_16px_40px_-34px_rgba(15,23,42,0.4)] md:bg-transparent md:shadow-none md:hover:bg-transparent"
                }`}
            ...
            >
              ...
              <span className="relative z-10 flex items-center justify-center gap-2">
                <span>Add-ons</span>
                <span className={`rounded-full px-2 py-0.5 text-xs font-semibold ${activeTab === "add-ons" ? "" : "bg-slate-100 text-slate-600"
                  }`} style={activeTab === "add-ons" ? {
                    backgroundColor: "rgba(var(--module-theme-rgb, 37,99,235), 0.14)",
                    color: "var(--module-theme-color, #2563EB)",
                  } : undefined}>
              ...
              {activeFilterOptions.map((option) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={`ml-2 inline-flex min-w-[20px] items-center justify-center rounded-full px-1.5 py-0.5 text-[11px] ${isActive ? "" : "bg-white text-slate-500"
                      }`} style={isActive ? {
                        ...
                        {(isPureVegRestaurant
                          ...
                          return (
                            <button
                              ...
                              className={`rounded-md border px-3 py-2 text-sm font-medium transition-colors ${active
                      ...
                      <div className="flex items-start justify-between gap-4">
                        <div className="flex-1 min-w-0">
                          <div className="mb-2 flex items-center gap-2 flex-wrap">
                            ...
                            <div
                              className={`h-4 w-4 rounded-sm border-2 flex items-center justify-center ${addon.isVeg === false || addon.foodType === "non-veg" ? "border-red-500" : ""
                                }`}
                              style={
                            ...
                            >
                              <span
                                className={`h-2 w-2 rounded-full ${addon.isVeg === false || addon.foodType === "non-veg" ? "bg-red-500" : ""
                                  }`}
                                style={
                                  addon.isVeg === false || addon.foodType === "non-veg"
                                    ? undefined
                            ...
                            <span
                              className={`rounded-full px-2 py-0.5 text-[11px] font-semibold ${addon.isVeg === false || addon.foodType === "non-veg"
                  ...
                  <label className="flex items-center justify-between py-4 cursor-pointer">
                    <div className="flex flex-col gap-1 flex-1">
                      ...
                      <p className="text-sm text-gray-500">
                        Item won't be visible to customers on EatAyu app till you mark it back in stock
                      </p>
                    </div>
                  </label>
                </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="pt-4">
                      <button
                        ...
                        className={`w-full h-16 rounded-[24px] text-base font-black flex items-center justify-center gap-3 transition-all relative overflow-hidden ${!bulkUploadFile || isUploading
