            ...
            <AnimatePresence mode="popLayout">
              {filteredOrders.length === 0 ? (
                ...
                <motion.div
                  ...
                  className={`bg-white border rounded-lg p-4 cursor-pointer hover:shadow-md transition-shadow ${selectedOrderId && (selectedOrderId === order.mongoId || selectedOrderId === order.id)
