export const adminSidebarMenu = [
    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          ...
          { label: "Onboarding Fee Settings", path: "/admin/food/restaurants/subscription-settings" },
        ],
      },
    ],
  },
  ...
  },
  {
    ...
    items: [
      ...
      { type: "link", label: "Multiorder Setting", path: "/admin/food/multiorder-setting", icon: "Layers" },
