...
async function fixImages() {
  try {
    ...
    const foods = db.collection('fooditems');
    ...
    console.log(`Fixed ${foodsUpdated} fooditems.`);

    // Fix addons collection
    const addons = db.collection('foodaddons'); // Or whatever the collection name is
    ...
    console.log(`Fixed ${addonsUpdated} foodaddons.`);

    // Fix restaurants collection
    const restaurants = db.collection('foodrestaurants');
    ...
    console.log(`Fixed ${restaurantsUpdated} foodrestaurants.`);
