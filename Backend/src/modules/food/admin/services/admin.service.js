...
export async function getRestaurantReport(query = {}) {
    ...
    if (allFilter === 'inactive') {
        // Inactive means approved but temporarily closed/disabled
        restaurantFilter.isOpen = false;
    }
    // Default (no filter or 'active'): only approved restaurants — already set above
        ...
        try {
            ...
            await notifyOwnersSafely(
                [{ ownerType: 'RESTAURANT', ownerId: updated.restaurantId }],
                {
                    ...
                    image: 'https://i.ibb.co/5GzXz7r/EatAyu-Brand-Image.png',
                    data: {
                        type: 'addon_approved',
        ...
        try {
            ...
            await notifyOwnersSafely(
                [{ ownerType: 'RESTAURANT', ownerId: updated._id }],
                {
                    ...
                    image: updated.profileImage || 'https://i.ibb.co/5GzXz7r/EatAyu-Brand-Image.png',
                    data: {
